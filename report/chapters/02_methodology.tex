...
%   \caption{Overview of the proposed DAVID-Net architecture.}
%   \label{fig:architecture}
% \end{figure}
\todo{Insert architecture diagram (Figure) and refer to it here.}
...
pseudo-classes are manufactured (Table~\ref{tab:qacp-classes}).
...
entirely. \todo{Add pipeline diagram figure.}
